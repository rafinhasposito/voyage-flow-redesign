    ...
    <div className="flex min-h-screen flex-col items-center justify-center bg-slate-50">
      <div className="w-full max-w-md p-8 bg-white rounded-3xl shadow-sm border border-slate-100">
        <div className="flex flex-col items-center mb-8">
          ...
          <h1 className="text-2xl font-bold font-display text-slate-900">Criar minha viagem</h1>
          <p className="text-sm text-slate-500 mt-2">Crie sua conta para começar.</p>
        </div>
